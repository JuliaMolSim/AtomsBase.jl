...
# TODO - maybe MH - think about a way to make 
# ChemicalSpecies(:C1) and similar work? 

@warn("Test set with isotopes has been temporarily removed.")
...
#     @test species(system, :) == ChemicalSpecies.([:C1, :C2, :D, :D, :D])
